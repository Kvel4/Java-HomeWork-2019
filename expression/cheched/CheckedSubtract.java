...
public class CheckedSubtract extends CheckedOperation {
    public CheckedSubtract(CheckedExpression arg1, CheckedExpression arg2) {
        super(arg1, arg2);
    }
    ...
    public int evaluate(int x, int y, int z) {
        ...
        if ((a2 < 0) && (a1 > Integer.MAX_VALUE + a2)){ /* `a1 - a2` would overflow */;
            throw new OverflowException("Overflow while evaluating");
        }else if ((a2 > 0) && (a1 < Integer.MIN_VALUE + a2)) { /* `a1 - a2` would underflow */;
            throw new OverflowException("Overflow while evaluating");
        }
        return a1 - a2;
    }
